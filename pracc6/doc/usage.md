...
get you started. [About the JavaScript](md).
...
[Read more about the `.editorconfig` file](c.md#editorconfig).
...
refer to the [according documentation](end.md#apple-touch-icons).

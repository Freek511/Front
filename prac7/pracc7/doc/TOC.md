...
* [Usage](ge.md) — Overview of the project contents.
* [FAQ](.md) — Frequently asked questions along with their answers.

## HTML5 Boilerplate core

* [HTML](l.md) — Guide to the default HTML.
* [CSS](.md) — Guide to the default CSS.
* [JavaScript](md) — Guide to the default JavaScript.
* [Everything else](c.md).

## Development

* [Extending and customizing HTML5 Boilerplate](end.md) — Going further with
  the boilerplate.
